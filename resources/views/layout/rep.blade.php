        ...
        <section class="sidebar">
            ...
            {{--</span>--}}
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/newuser"><i class="fa fa-circle-o"></i> Add New User</a></li>
                        {{--<li><a href="/updateuser"><i class="fa fa-circle-o"></i> Update User</a></li>--}}
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/newproduct"><i class="fa fa-circle-o"></i> Add New Product</a></li>
                        <li><a href="/products"><i class="fa fa-circle-o"></i> View Inventory</a></li>
                        {{--<li><a href="pages/UI/buttons.html"><i class="fa fa-circle-o"></i> Update Inventory</a></li>--}}
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        {{--<li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i> Pending</a></li>--}}
                        {{--<li><a href="pages/forms/editors.html"><i class="fa fa-circle-o"></i> Devlivered</a></li>--}}
                        {{--<li><a href="pages/forms/editors.html"><i class="fa fa-circle-o"></i> Reserved</a></li>--}}
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
